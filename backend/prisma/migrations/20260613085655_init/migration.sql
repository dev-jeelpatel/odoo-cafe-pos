-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('ADMIN', 'EMPLOYEE', 'CASHIER');
...
-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('DRAFT', 'PENDING', 'CONFIRMED', 'PREPARING', 'READY', 'SERVED', 'COMPLETED', 'CANCELLED');

-- CreateEnum
CREATE TYPE "KitchenStatus" AS ENUM ('PENDING', 'TO_COOK', 'PREPARING', 'COMPLETED');
...
-- CreateEnum
CREATE TYPE "ProductUnit" AS ENUM ('PIECE', 'KG', 'LITER');

-- CreateEnum
CREATE TYPE "AuditAction" AS ENUM ('CREATE', 'UPDATE', 'DELETE', 'LOGIN', 'LOGOUT', 'PAYMENT', 'SESSION_OPEN', 'SESSION_CLOSE');
...
CREATE TABLE "Session" (
    ...
    "closingAmount" DOUBLE PRECISION NOT NULL DEFAULT 0,
    ...
    "discountsApplied" DOUBLE PRECISION NOT NULL DEFAULT 0,
...
-- AddForeignKey
ALTER TABLE "Promotion" ADD CONSTRAINT "Promotion_conditionProductId_fkey" FOREIGN KEY ("conditionProductId") REFERENCES "Product"("id") ON DELETE SET NULL ON UPDATE CASCADE;
